...
const steps = [
  {
    ...
    description: "Run the installer on macOS or Linux.",
...
function Hero() {
  return (
    <section className="mx-auto grid w-full max-w-6xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-24">
      <div className="animate-in space-y-7 duration-700 fade-in slide-in-from-bottom-3">
        <span className="inline-flex items-center gap-2 border border-border bg-muted/40 px-3 py-1 font-mono text-xs tracking-wide text-muted-foreground">
          <span className="size-1.5 animate-pulse bg-emerald-500" />
          Open source · Self-hostable
        </span>

        <h1 className="font-heading text-4xl leading-[1.08] font-medium tracking-tight sm:text-5xl lg:text-6xl">
          Localhost,
          <br />
          publicly reachable.
        </h1>
        ...
        <p className="max-w-lg text-base leading-relaxed text-muted-foreground">
          OpenTunnel gives your local apps persistent public domains—perfect for
          webhooks, live demos, and mobile testing. No ports to open, no router
          to fight, no traffic left unseen.
        </p>
        ...
        <div className="flex max-w-md items-center justify-between gap-2 border border-border bg-muted/30 px-3 py-2 font-mono text-xs">
  ...
  return (
    <div className="border border-border bg-zinc-950 shadow-[0_32px_80px_-40px_rgba(0,0,0,0.6)]">
      <div className="flex items-center gap-2 border-b border-white/10 px-4 py-3">
        <span className="size-2.5 bg-[#ff5f56]" />
        <span className="size-2.5 bg-[#ffbd2e]" />
        <span className="size-2.5 bg-[#27c93f]" />
...
function HowItWorks() {
  return (
    <section className="border-t border-border bg-muted/20" id="how-it-works">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="flex size-8 items-center justify-center border border-border bg-muted font-mono text-sm font-medium">
                  {index + 1}
                </span>
              ...
              <div className="mt-4 overflow-x-auto border border-border bg-zinc-950 px-3 py-2 font-mono text-xs text-zinc-100">
      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <p className="text-base leading-relaxed text-muted-foreground">
            ...
            payloads, status codes, and timing. Filter by method or status, dig
            into a single call, and replay it instantly to reproduce the exact
            conditions that broke your code.
          </p>
        ...
        <div className="border border-border bg-card">
          ...
          <div className="divide-y divide-border">
            {sampleRequests.map((request, index) => (
              <div
                className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-3 px-4 py-3 font-mono text-xs"
      ...
      <div className="relative overflow-hidden border border-border bg-zinc-950 px-6 py-16 text-center">
        ...
        <div className="relative mx-auto max-w-2xl space-y-6">
          ...
          <p className="text-base leading-relaxed text-zinc-400">
            Spin up a persistent, inspectable public URL for your local app in
            seconds. Free, open source, and yours to self-host.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Button render={<Link to="/login" />} size="lg" variant="secondary">
              Get started
              <ArrowRightIcon />
            </Button>
            <Button
