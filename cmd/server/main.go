...
import (
	...
	"github.com/opentunnel/opentunnel/internal/server"
	"github.com/opentunnel/opentunnel/internal/storage"
	"github.com/opentunnel/opentunnel/migrations"
)
...
func run() error {
	...
	handler := server.New(server.Config{
		BaseURL: baseURL, PublicHost: publicHost, SecureCookies: secureCookies,
